...
'use strict';
     ...
     */
    function _reset() {
        _set(els.deviceValue, '--'); _set(els.deviceSub, '');
        _set(els.cpuValue, '--'); _set(els.cpuSub, ''); _setBar(els.cpuFill, 0);
        _set(els.memValue, '--'); _setBar(els.memFill, 0);
        _set(els.diskValue, '--'); _setBar(els.diskFill, 0);
        _set(els.netValue, '--'); _set(els.netSub, '');
        _set(els.batteryValue, '--'); _set(els.batterySub, ''); _setBar(els.batteryFill, 0);
        _set(els.svcValue, '--'); _set(els.svcSub, '');
    ...
    const Dashboard = {
        init: _init,
        onTabEnter: _onTabEnter, onTabLeave: _onTabLeave
    };
